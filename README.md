...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,239 | 🐛 105 | 📅 2026-08-18 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 552 | 🐛 58 | 🌐 Dockerfile | 📅 2026-08-20 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Deiko-config](http://hackage.haskell.org/package/deiko-config) - small typesafe library that uses [HOCON](https://github.com/lightbend/config#features-of-hocon) ⭐ 6,312 | 🐛 243 | 🌐 Java | 📅 2026-07-01 config format
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 967 | 🐛 167 | 🌐 Dhall | 📅 2026-08-20 - A configuration language guaranteed to terminate
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,997 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Haskell code with zero dependencies.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,286 | 🐛 1,206 | 🌐 Haskell | 📅 2026-08-20 - the first chat platform that is 100% private by design - it has no access to your connection graph!
