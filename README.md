...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,176 | 🐛 105 | 📅 2026-08-21 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 552 | 🐛 62 | 🌐 Dockerfile | 📅 2026-08-30 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,330 | 🐛 1,218 | 🌐 Haskell | 📅 2026-08-29 - the first chat platform that is 100% private by design - it has no access to your connection graph!
