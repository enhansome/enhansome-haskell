...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,086 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 551 | 🐛 63 | 🌐 Dockerfile | 📅 2026-09-14 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 973 | 🐛 167 | 🌐 Dhall | 📅 2026-09-14 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,435 | 🐛 1,247 | 🌐 Haskell | 📅 2026-09-14 - the first chat platform that is 100% private by design - it has no access to your connection graph!
