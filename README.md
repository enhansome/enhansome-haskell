...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,899 | 🐛 105 | 📅 2026-08-21 projects line.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 970 | 🐛 165 | 🌐 Dhall | 📅 2026-08-28 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,333 | 🐛 1,217 | 🌐 Haskell | 📅 2026-08-29 - the first chat platform that is 100% private by design - it has no access to your connection graph!
