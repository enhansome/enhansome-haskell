...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,148 | 🐛 100 | 📅 2026-06-30 projects line.
...
* [Stack](https://github.com/commercialhaskell/stack) ⭐ 4,076 | 🐛 611 | 🌐 Haskell | 📅 2026-08-14 - a cross-platform tool to help on building Haskell projects. It includes support to create isolated Haskell environments and to automatically manage the dependencies of a project.
* [Stackage](https://github.com/fpco/stackage) ⭐ 552 | 🐛 55 | 🌐 Dockerfile | 📅 2026-08-15 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Deiko-config](http://hackage.haskell.org/package/deiko-config) - small typesafe library that uses [HOCON](https://github.com/lightbend/config#features-of-hocon) ⭐ 6,311 | 🐛 243 | 🌐 Java | 📅 2026-07-01 config format
...
* [Haxl](https://github.com/facebook/Haxl) ⭐ 4,380 | 🐛 8 | 🌐 Haskell | 📅 2026-03-15 - a library for efficient, concurrent, concise data access.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,265 | 🐛 1,209 | 🌐 Haskell | 📅 2026-08-15 - the first chat platform that is 100% private by design - it has no access to your connection graph!
