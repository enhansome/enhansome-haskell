...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,298 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 551 | 🐛 63 | 🌐 Dockerfile | 📅 2026-09-07 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 971 | 🐛 170 | 🌐 Dhall | 📅 2026-09-07 - A configuration language guaranteed to terminate
...
* [Haxl](https://github.com/facebook/Haxl) ⭐ 4,375 | 🐛 8 | 🌐 Haskell | 📅 2026-03-15 - a library for efficient, concurrent, concise data access.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 3,000 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Haskell code with zero dependencies.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,405 | 🐛 1,234 | 🌐 Haskell | 📅 2026-09-08 - the first chat platform that is 100% private by design - it has no access to your connection graph!
