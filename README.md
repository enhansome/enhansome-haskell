...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,791 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 551 | 🐛 63 | 🌐 Dockerfile | 📅 2026-09-13 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,427 | 🐛 1,244 | 🌐 Haskell | 📅 2026-09-13 - the first chat platform that is 100% private by design - it has no access to your connection graph!
...
* [learnhaskell](https://github.com/bitemyapp/learnhaskell) ⭐ 8,031 | 🐛 13 | 🌐 Makefile | 📅 2026-07-20 - Haskell Learning (also for non-English speakers).
