...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,692 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 551 | 🐛 63 | 🌐 Dockerfile | 📅 2026-09-06 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,391 | 🐛 1,229 | 🌐 Haskell | 📅 2026-09-06 - the first chat platform that is 100% private by design - it has no access to your connection graph!
