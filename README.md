...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,179 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 551 | 🐛 64 | 🌐 Dockerfile | 📅 2026-09-11 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 972 | 🐛 167 | 🌐 Dhall | 📅 2026-09-10 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,417 | 🐛 1,241 | 🌐 Haskell | 📅 2026-09-11 - the first chat platform that is 100% private by design - it has no access to your connection graph!
