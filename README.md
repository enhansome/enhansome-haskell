...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,065 | 🐛 105 | 📅 2026-08-21 projects line.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 971 | 🐛 167 | 🌐 Dhall | 📅 2026-09-01 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,362 | 🐛 1,222 | 🌐 Haskell | 📅 2026-09-01 - the first chat platform that is 100% private by design - it has no access to your connection graph!
