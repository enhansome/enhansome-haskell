...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,425 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 973 | 🐛 167 | 🌐 Dhall | 📅 2026-09-15 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,446 | 🐛 1,248 | 🌐 Haskell | 📅 2026-09-15 - the first chat platform that is 100% private by design - it has no access to your connection graph!
