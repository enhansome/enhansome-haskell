...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,005 | 🐛 106 | 📅 2026-09-02 projects line.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 3,001 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native Haskell code with zero dependencies.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,403 | 🐛 1,232 | 🌐 Haskell | 📅 2026-09-07 - the first chat platform that is 100% private by design - it has no access to your connection graph!
...
* [learnhaskell](https://github.com/bitemyapp/learnhaskell) ⭐ 8,035 | 🐛 13 | 🌐 Makefile | 📅 2026-07-20 - Haskell Learning (also for non-English speakers).
