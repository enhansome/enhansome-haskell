...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,930 | 🐛 106 | 📅 2026-08-21 projects line.
...
* [Stackage](https://github.com/fpco/stackage) ⭐ 552 | 🐛 63 | 🌐 Dockerfile | 📅 2026-08-25 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 968 | 🐛 168 | 🌐 Dhall | 📅 2026-08-25 - A configuration language guaranteed to terminate
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,307 | 🐛 1,214 | 🌐 Haskell | 📅 2026-08-25 - the first chat platform that is 100% private by design - it has no access to your connection graph!
