...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,491 | 🐛 105 | 📅 2026-08-21 projects line.
...
* [Stack](https://github.com/commercialhaskell/stack) ⭐ 4,078 | 🐛 607 | 🌐 Haskell | 📅 2026-08-22 - a cross-platform tool to help on building Haskell projects. It includes support to create isolated Haskell environments and to automatically manage the dependencies of a project.
* [Stackage](https://github.com/fpco/stackage) ⭐ 552 | 🐛 63 | 🌐 Dockerfile | 📅 2026-08-30 - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Deiko-config](http://hackage.haskell.org/package/deiko-config) - small typesafe library that uses [HOCON](https://github.com/lightbend/config#features-of-hocon) ⭐ 6,313 | 🐛 242 | 🌐 Java | 📅 2026-07-01 config format
* [Dhall](https://github.com/dhall-lang/dhall-haskell) ⭐ 970 | 🐛 166 | 🌐 Dhall | 📅 2026-08-29 - A configuration language guaranteed to terminate
...
* [Haxl](https://github.com/facebook/Haxl) ⭐ 4,377 | 🐛 8 | 🌐 Haskell | 📅 2026-03-15 - a library for efficient, concurrent, concise data access.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) ⭐ 19,341 | 🐛 1,218 | 🌐 Haskell | 📅 2026-08-30 - the first chat platform that is 100% private by design - it has no access to your connection graph!
...
* [Awesome Haskell Videos](https://github.com/andys8/awesome-haskell-videos) ⭐ 47 | 🐛 0 | 🌐 TypeScript | 📅 2023-06-26 - Curated list of Haskell talks and tutorials
